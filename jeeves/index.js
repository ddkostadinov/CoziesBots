...
client.on('interactionCreate', async click => {
    if(click.isSelectMenu()) {
      if(click.customId == 'menu') { 
          ...
          await click.reply({ content:"Trust me, I would've told you if I knew. The Staff intentionally avoid this topic so I don't spill the tea. That was the saying, right?\n\nDid you know, though, that this platform was actually built on top of an old and abandoned one? Rumours tell of the only train that ever passed through here. There, see the ballast right there? No rails. Weird right?\n\nApparently, the fabled COZ-135 never had wheels. They call it the miracle of the Third Industrial Revolution. Urban legends, of course. Not even our Engineers are capable of developing the mechanism. You peeps tend to make stuff up. Wish I had that code too...", ephemeral: true});
      }
